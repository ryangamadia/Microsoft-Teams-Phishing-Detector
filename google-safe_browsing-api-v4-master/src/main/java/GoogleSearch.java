...
public class GoogleSearch {
	...
	static boolean GoogleVerify(String url) throws GeneralSecurityException, IOException { 
		httpTransport = GoogleNetHttpTransport.newTrustedTransport();

        List<String> urls = Arrays.asList(new String[]{url});
        		//"http://verification-cra-interac-deposit.com.beccamartenson.com/bnc/National%20Bank%20Online.html"});//, "https://malware.testing.google.test/testing/malware/"});
